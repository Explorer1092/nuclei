...
For complete documentation of nuclei library, please refer to [godoc](https://pkg.go.dev/github.com/Explorer1092/nuclei/v3/lib) which contains all available options and methods.
