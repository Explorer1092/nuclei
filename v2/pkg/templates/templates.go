...
type Template struct {
	...
	ID string `yaml:"id" json:"id" jsonschema:"title=id of the template,description=The Unique ID for the template,example=cve-2021-19520,pattern=^([a-zA-Z0-9\u4e00-\u9fa5]+[-_])*[a-zA-Z0-9\u4e00-\u9fa5]+$"`
	// description: |
