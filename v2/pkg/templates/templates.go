...
import (
	...
	"github.com/Explorer1092/nuclei/v2/pkg/protocols/headless"
	"github.com/Explorer1092/nuclei/v2/pkg/protocols/http"
	"github.com/Explorer1092/nuclei/v2/pkg/protocols/network"
	"github.com/Explorer1092/nuclei/v2/pkg/protocols/ssl"
	"github.com/Explorer1092/nuclei/v2/pkg/protocols/websocket"
	"github.com/Explorer1092/nuclei/v2/pkg/protocols/whois"
...
type Template struct {
	...
	ID string `yaml:"id" json:"id" jsonschema:"title=id of the template,description=The Unique ID for the template,example=cve-2021-19520,pattern=^([a-zA-Z0-9\p{Han}\!\(\)\.]+[-_])*[a-zA-Z0-9\p{Han}\!\(\)\.]+$"`
	// description: |
