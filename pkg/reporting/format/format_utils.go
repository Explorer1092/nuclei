...
<<<<<<< HEAD:v2/pkg/reporting/format/format_utils.go
...
>>>>>>> 7f556f8e33080a9eb2e52a9c14fa2e16f32f62c3:pkg/reporting/format/format_utils.go
)
...
func CreateReportDescription(event *output.ResultEvent, formatter ResultFormatter, omitRaw bool) string {
	...
	builder.WriteString(fmt.Sprintf("Generated by %s", formatter.CreateLink("Nuclei "+config.Version, "https://github.com/Explorer1092/nuclei")))
	data := builder.String()
	return data
}
